...
config_path = "E:/PROJECT/beacon-desktop-electron/beacon_package/phobert-base/config.json"
model_path = "E:/PROJECT/beacon-desktop-electron/beacon_package/phobert-base/model.bin"
  ...
  def train_classifier(self):
    ...
    for epoch_i in range(0, self.epochs):
      ...
      for step, batch in enumerate(self.train_dataloader):
        ...
        optimizer.step()
        if step % 100 == 0:
          print("[TRAIN] Epoch {}/{} | Batch {}/{} | Train Loss={} | Train Acc={}".format(epoch_i, self.epochs, step,
