const chromeDriver = require("../utils/driver");
const readline = require("readline");
const { promisify } = require("util");
const NewsReader = require("../utils/newsReader");
const { SearchNewsBy } = require("../constants/newsTypes");
        ...
        try {
            ...
            switch (command) {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    let keyword = await questionAsync(
                        "Nhập keyword bạn muốn tìm:\n"
                    );
